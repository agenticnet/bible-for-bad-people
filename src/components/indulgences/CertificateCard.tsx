...
export default function CertificateCard({ purchase }: CertificateCardProps) {
  return (
    <div className="relative overflow-hidden rounded-xl border-2 border-neon-gold/40 bg-gradient-to-br from-shadow via-abyss to-shadow p-6">
      ...
      <div className="relative text-center">
        ...
        <p className="mb-1 text-[10px] uppercase tracking-[0.4em] text-neon-gold/70">
        ...
        <p className="mb-4 text-sm font-semibold text-bone">{purchase.productName}</p>

        <div className="mx-auto mb-4 max-w-xs rounded-lg border border-neon-gold/20 bg-neon-gold/5 px-4 py-3">
          <p className="text-[10px] uppercase tracking-wider text-muted">Certificate ID</p>
        ...
        <p className="mt-4 text-[10px] italic text-muted/50">
