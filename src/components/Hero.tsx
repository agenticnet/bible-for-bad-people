    ...
    <section className="relative overflow-hidden px-4 pt-32 pb-20 sm:px-6 sm:pt-40 sm:pb-28">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/chat"
            className="group flex items-center gap-2 rounded-xl border border-neon-gold/60 bg-neon-gold/15 px-8 py-4 text-base font-semibold text-neon-gold transition-all hover:border-neon-gold hover:bg-neon-gold/25 hover:shadow-[0_0_30px_rgba(251,191,36,0.4)]"
          >
            Speak with GOD
          ...
          <Link
            href="/#features"
            className="rounded-xl border border-ash px-8 py-4 text-base text-muted transition-colors hover:border-neon-purple/50 hover:text-bone"
          >
            Explore Features
          </Link>
        </div>
