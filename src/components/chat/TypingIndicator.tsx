export default function TypingIndicator() {
  return (
    <div className="flex gap-3">
      ...
      <div className="rounded-2xl rounded-tl-sm border border-neon-gold/20 bg-shadow px-5 py-4">
        <p className="mb-2 text-[10px] uppercase tracking-[0.2em] text-neon-gold/70">
          GOD is typing...
        </p>
